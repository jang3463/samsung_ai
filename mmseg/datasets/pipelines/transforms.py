...
class LensDistortion(object):
    def __init__(self, prob, d_coef=(0.15, 0.15, 0.1, 0.1, 0.05)):
        self.prob = prob
    ...
    def __call__(self, results):
        ...
        results['img'] = cv2.remap(src, *remap, cv2.INTER_LINEAR)
        results['gt_semantic_seg'] = cv2.remap(src_mask, *remap, cv2.INTER_LINEAR)
