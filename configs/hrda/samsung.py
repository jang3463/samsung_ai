...
_base_ = [
    ...
    # '../_base_/models/samsung/convnext_sepaspp.py',
    # GTA->Cityscapes High-Resolution Data Loading
    '../_base_/datasets/uda_samsung_1024x1024.py',
...
model = dict(
    ...
    decode_head=dict(
        ...
        num_classes = 12,
        # loss_decode=[dict(type='CrossEntropyLoss', loss_name='loss_ce', loss_weight=0.75),
        #              dict(type='DiceLoss', loss_name='loss_dice', loss_weight=0.25)],
        loss_decode = dict(type='CrossEntropyLoss', loss_name='loss_dice', loss_weight=1.0),
